...
if __name__ == "__main__":
    ...
    # load the data
    filePath = "/home/anht/AI_Class/Assignment/CIS419/hw1/univariateData.dat"
    ...
    init_theta = np.matrix(np.ones((d+1,1)))*10  
    # note that we really should be initializing this to be near zero, but starting it 
    # near [10,10] works better to visualize gradient descent for this particular problem
    n_iter = 2000
    alpha = 0.01
